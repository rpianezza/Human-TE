...
Note that the L1ME5 TE, which was always present in the analysis with all the samples, is completely disappeared from the absolute variant TE plots. This TE was previously identified as having an uneven coverage, with just one small region that was present at very high frequency that caused its high variability in copynumber estimate. Furthermore, this sequence was identified as AT-microsatellite, thus confirming the fact that PCR is having a lot of problem in dealing with satellites.