...
```
    ...
    ## Warning in cor.test.default(m_processed$lat, m_processed$PC1, method =
    ## "spearman"): Cannot compute exact p-value with ties

    ## Warning in cor.test.default(m_processed$lat, m_processed$PC2, method =
    ## "spearman"): Cannot compute exact p-value with ties

    ## Warning in cor.test.default(m_processed$lon, m_processed$PC1, method =
    ## "spearman"): Cannot compute exact p-value with ties

    ## Warning in cor.test.default(m_processed$lon, m_processed$PC2, method =
    ## "spearman"): Cannot compute exact p-value with ties
...
```
    ...
    ##   <chr> <dbl>  <dbl>  <dbl>     <dbl>
    ## 1 male      1  0.162  0.198 0.00111  
    ## 2 male      2 -0.194 -0.118 0.0000938
...
```
    ...
    ##   sex       PC    lat      lon  p_value
    ##   <chr>  <dbl>  <dbl>    <dbl>    <dbl>
    ## 1 female     1 -0.478  0.199   7.00e-16
    ## 2 female     2  0.398 -0.00764 4.98e-11
...
```
    ...
    ## Warning in cor.test.default(m_processed$distance, m_processed$PC1, method =
    ## "spearman"): Cannot compute exact p-value with ties

    ## Warning in cor.test.default(m_processed$distance, m_processed$PC2, method =
    ## "spearman"): Cannot compute exact p-value with ties
...
```
    ...
    ##   <chr> <dbl>  <dbl>       <dbl>
    ## 1 male      1  0.248 0.000000847
    ## 2 male      2 -0.128 0.0119
...
```
    ...
    ##   sex       PC  coeff p_value
    ##   <chr>  <dbl>  <dbl>   <dbl>
    ## 1 female     1 0.0899   0.160
    ## 2 female     2 0.100    0.117
...
![](05.coordinates_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
