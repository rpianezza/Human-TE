...
* **HGDP_final** = only the GC-bias free samples in the HGDP, defined as the samples for which the parabolic quadratic coefficient **a** is neither >0.5 or <0.5, meaning that the estimated copynumber for the sequence is not strongly influenced by the GC-bias (check the script *other-documentation/GC-bias* for more).
...
* **distances** = kilometric distance from the out of Africa (Egypt) for all the population in the dataset
